...
function popupModal(speakerModal, speakerBtn, speakerSpan) {
	...
	var MKBtn = document.getElementById("more-info-MK");
	// Get the <span> element that closes the modal
	var MKmodalClose = document.getElementsByClassName("MKmodalClose")[0];
	popupModal(MKmodal, MKBtn, MKmodalClose);
	
	// Get the modal
	var AMmodal = document.getElementById("AMmodal");
	// Get the button that opens the modal
	var AMBtn = document.getElementById("more-info-AM");
	// Get the <span> element that closes the modal
	var AMmodalClose = document.getElementsByClassName("AMmodalClose")[0];
	popupModal(AMmodal, AMBtn, AMmodalClose);
